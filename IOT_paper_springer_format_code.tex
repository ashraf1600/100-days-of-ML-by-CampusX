...
\author{
    Ashraf-Ul-Islam\inst{1} \and 
    Towhidul Islam\inst{2} \and 
    Mahfuzulhoq Chowdhury\inst{3}
}

\authorrunning{Ashraf-Ul-Islam et al.} % abbreviated author list for running head

\tocauthor{Ashraf-Ul-Islam, Towhidul Islam, Mahfuzulhoq Chowdhury} % for TOC

\institute{
    Dept. of Computer Science and Engineering, \\
    Chittagong University of Engineering and Technology (CUET), Bangladesh \\
    \email{u2104096@student.cuet.ac.bd, u2104023@student.cuet.ac.bd, mahfuzcsecuet@yahoo.com}
}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figure/hyperparameter_and_model_acc.png}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figure/Proposed model confusion matrix_(d)_SHAP analysis.png}
       
    \end{subfigure}
   
   \caption{\frenchspacing (a) Random search based tuning (ensemble), (b) Model comparison, (c) Proposed model confusion matrix, (d) SHAP analysis}
    \label{fig:dataset}
...
\begin{table}[t]
\caption{COMPARISON AMONG PROPOSED AND EXISTING WORK}
...
\hline
Simhon et al., \cite{ref6}, GNN & 88.80\%  & 82.50\%  & 78.01\%  & 80.25\%  \\
Soomro et al., \cite{ref9}, DFL& 98.70\%  & 98.80\% & 98.60\% & 98.70\% \\
Sun et al.,\cite{ref11},LSTM, AE & 98.48\% & 98.40\% & 98.02\% & 98.21\% \\

Proposed ensemble voting approach & 99.94\%  &  99.94\% &  99.94\% & 99.94\% \\
\hline
\end{tabular}
